...
1. https://posit.cloud にアクセスし、**Gmailアカウント**でログインする。
...
## 練習4
最後に、標準正規分布に従う乱数1000個を発生し、ヒストグラム図を作成する上で、標準正規分布の曲線と比較しよう。
...
# アンケート
RやR Studio、Github Desktopのインストールについて確認します。大学のアカウントでログインする上で記入してください。

https://docs.google.com/forms/d/e/1FAIpQLSfLFkqXiWBLKg22LbbEoqCh5YAx6r-5mC_MWgBhV3h8UVQUGw/viewform?usp=dialog
