...
# Rとは
![R logo](./graph/R_logo.svg.png){height=20mm}　
...
![Posit Cloud Login](./graph/R-Posit1.png){width=50%}　

2.New Project > New RStudio Project を選択

![New RStudio Project](./graph/R-Posit2.png)　

3.少し時間を置いてから、RStudio の画面を確認するのである。

![RStudio画面](./graph/R-Posit3.png)　
...
![](./graph/RStudio_logo_flat.svg.png){height=20mm}
...
![RやRStudioの関係](./graph/R-RStudio.png)　　
...
1. GitHubアカウントを新規作成  
 ...
 「Continue with Goggle」をクリックし、**<span style="color:red">大学のGmailアカウント</span>**でログインしなさい。成績評価の関係上、個人のGmailは使ってはいけない。
    ...
    ![GitHubログイン](./graph/github3.png){width=50%}　
