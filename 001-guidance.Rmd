...
# Rとは
![R logo](./001-guidance_files/R_logo.svg.png){height=20mm}　
...
![Rの起動画面](./001-guidance_files/R-first.png)  
...
![Posit Cloud Login](./001-guidance_files/R-Posit1.png){width=50%}　

2.New Project > New RStudio Project を選択

![New RStudio Project](./001-guidance_files/R-Posit2.png)　

3.少し時間を置いてから、RStudio の画面を確認するのである。

![RStudio画面](./001-guidance_files/R-Posit3.png)　
...
![](./001-guidance_files/RStudio_logo_flat.svg.png){height=20mm}
...
![RやRStudioの関係](./001-guidance_files/R-RStudio.png)　　
...
![](./001-guidance_files/github.png){height=30mm}
...
![出所: UnrealEngine5の教科書 [ゲーム開発入門続編,第二巻]](./graph/github2.png)
...
1. GitHubアカウントを新規作成  
 ...
 「Continue with Goggle」をクリックし、**<span style="color:red">大学のGmailアカウント</span>**でログインしなさい。成績評価の関係上、個人のGmailは使ってはいけない。
    ...
    ![GitHubログイン](./001-guidance_files/github3.png){width=50%}　
...
（手動でnameを変更する場合、学籍番号が追跡できなくなる）
    ...
    ![GitHubログイン](./001-guidance_files/github4.png)　
